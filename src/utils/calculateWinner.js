...
export const calculateWinner = (squares) => {
  const lines = [
    ...
    [0, 7, 14, 21], [7, 12, 21, 28], [14, 21, 28, 35],
    [1, 8, 15, 22], [8, 15, 22, 29], [15, 22, 29, 36],
    [2, 9, 16, 23], [9, 16, 23, 30], [16, 23, 30, 37],
    [3, 10, 17, 24], [10, 17, 24, 31], [17, 24, 31, 38],
    [4, 11, 18, 25], [11, 18, 25, 32], [18, 25, 32, 39],
    [5, 12, 19, 26], [12, 19, 26, 33], [19, 26, 33, 20],
...
export const droppingDown = (array, arrayIndex) => {
  const droppingColumn = columns.find(newColumn => newColumn.column === arrayIndex % 7).squares;

  return droppingColumn.find((index) => array[index] === null);
};